<?php
// === FILE FRONTEND: kelola_ketua_pjp.php ===
if (!isset($conn)) {
...
<div class="container mx-auto relative">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <button id="tambahPjpBtn" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg flex items-center gap-2 shadow transition transform hover:scale-105">
                ...
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                            <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Hapus Ketua PJP</h3>
                            <div class="mt-2">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const API_URL = 'pages/master/ajax_kelola_ketua_pjp.php'; // Sesuaikan path
        ...
        // --- MANAJEMEN MODAL ---
        const modals = {
            tambah: document.getElementById('tambahPjpModal'),
        ...
        document.getElementById('tambahPjpBtn').onclick = () => {
            document.getElementById('formTambahPjp').reset();
            document.getElementById('msgCekWaTambah').classList.add('hidden');
            isWaValidated_Tambah = false;
        ...
        function renderTable(data) {
            const tbody = document.getElementById('pjpTableBody');
            tbody.innerHTML = '';
                    ...
                    <div class="flex flex-col gap-2 w-max mx-auto">
                        ...
                        ${userRoleSession === 'superadmin' ? `
                            <button class="reset-pin-btn text-left text-yellow-600 hover:text-yellow-800"
                                data-id="${p.id}" data-nama="${p.nama}" data-barcode="${p.barcode}" data-role="ketua pjp">
            ...
            if (e.target.closest('.qr-code-btn')) {
                ...
                newDownloadLink.addEventListener('click', function() {
                    ...
                    let pesanDinamis = tingkatPemilik == 'desa' ?
                        `Mendownload file QR Code *${namaPemilik}* - Ketua PJP Desa.` :
                        `Mendownload file QR Code *${namaPemilik}* - Ketua PJP Kelompok ${kelompokPemilik}.`;
        ...
        function submitAjaxForm(e, manualData = null) {
            ...
            if (manualData) {
                ...
                if (actionType === 'tambah_pjp' && !isWaValidated_Tambah) {
        ...
        document.getElementById('formTambahPjp').addEventListener('submit', submitAjaxForm);
        document.getElementById('formEditPjp').addEventListener('submit', submitAjaxForm);
        document.getElementById('formHapusPjp').addEventListener('submit', submitAjaxForm);
