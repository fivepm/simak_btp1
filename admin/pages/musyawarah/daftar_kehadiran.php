...
<div class="p-6">
    <h1 class="text-3xl font-bold text-gray-800 mb-4">Daftar Kehadiran Musyawarah</h1>
                            ...
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4 text-center">
                                    <div class="grid grid-cols-1 gap-2">
                                        <!-- TOMBOL BARU: DAFTAR HADIR -->
                                        <a href="?page=musyawarah/daftar_hadir&id=<?php echo $row['id']; ?>" class="bg-green-500 hover:bg-green-600 text-white font-bold p-2 rounded-lg text-xs transition duration-300" title="Daftar Hadir">
                                            <i class="fas fa-users"></i> Kelola Daftar Hadir
                                        </a>
                                        <a href="?page=musyawarah/lihat_kehadiran&id=<?php echo $row['id']; ?>" class="bg-blue-500 hover:bg-blue-600 text-white font-bold p-2 rounded-lg text-xs transition duration-300" title="Daftar Hadir">
                                            <i class="fa-solid fa-eye"></i> Lihat Kehadiran
                                        </a>
                                    </div>
