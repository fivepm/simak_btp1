...
// === CCTV ===
$desc_log = "Mencetak Kartu Akses *Guru* (" . ucwords($guru['kelompok']) . "): *" . ucwords($guru['nama']) . "*.";
...
imagettftext($template_image, 15, 0, 185, 808, $warna_teks, $font_path, ucfirst($guru['kelompok']));
