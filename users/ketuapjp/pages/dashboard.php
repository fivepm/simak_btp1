...
// Ambil data sesi ketua pjp
$ketua_pjp_level = $_SESSION['user_tingkat'] ?? 'desa';
...
if ($periode_aktif_id) {
    ...
    if ($ketua_pjp_level === 'kelompok' && $ketuapjp_kelompok) {
        $sql_kehadiran_global .= " AND p.kelompok = ?";
        $bind_types_global .= "s";
        $bind_values_global[] = $ketuapjp_kelompok;
    }
    ...
    if ($ketua_pjp_level === 'kelompok' && $ketuapjp_kelompok) {
        ...
        $bind_types_kelas .= "s";
        $bind_values_kelas[] = $ketuapjp_kelompok;
    }
    ...
    if ($ketua_pjp_level === 'kelompok' && $ketuapjp_kelompok) {
        ...
        $bind_values_hari_ini[] = $ketuapjp_kelompok;
    }
    ...
    //     $bind_types_draft .= "s";
    //     $bind_values_draft[] = $ketuapjp_kelompok;
    // }
    ...
    if ($ketua_pjp_level === 'kelompok' && $ketuapjp_kelompok) {
        ...
        $bind_values_terlewat[] = $ketuapjp_kelompok;
    }
    $sql_terlewat .= " AND (
    ...
    if ($ketua_pjp_level === 'kelompok' && $ketuapjp_kelompok) {
        ...
        $bind_values_tanpa_guru[] = $ketuapjp_kelompok;
    }
    ...
    if ($ketua_pjp_level === 'kelompok' && $ketuapjp_kelompok) {
        ...
        $bind_values_akan_datang[] = $ketuapjp_kelompok;
    }
...
<div class="container mx-auto p-4 sm:p-6 lg:p-8">
    ...
    <div class="mb-6 text-center">
        <h1 class="text-3xl font-bold text-gray-800">Dashboard Ketua PJP <?php echo ucwords($ketua_pjp_level) ?></h1>
        <?php if ($ketua_pjp_level === 'kelompok'): ?>
            <p class="text-gray-500 mt-1">Menampilkan data untuk Kelompok <span class="font-semibold capitalize"><?php echo htmlspecialchars($ketuapjp_kelompok); ?></span></p>
        <?php endif; ?>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-lg flex items-center">
            ...
            <div>
                <p class="text-gray-500 text-sm">Rata-rata Kehadiran <?php echo ($ketua_pjp_level === 'kelompok' ? 'Kelompok ' . htmlspecialchars($ketuapjp_kelompok) : 'Global'); ?></p>
        ...
        <!-- <div class="bg-white p-6 rounded-2xl shadow-lg flex items-center">
            ...
            <div>
                ...
                <?php if ($data['laporan_draft'] > 0 && $ketua_pjp_level === 'kelompok'): ?>
