                    ...
                    <?php foreach ($laporan_list as $laporan): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium space-x-2">
                                <a href="?page=report/lihat_laporan_mingguan&id=<?php echo $laporan['id']; ?>" class="text-cyan-600 hover:text-cyan-900" title="Lihat"><i class="fas fa-eye"></i> Lihat Laporan</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
