...
// Digunakan untuk Grafik Kehadiran Role Pembina
require_once '../../config/config.php'; // Sesuaikan path jika berbeda

session_start();
header('Content-Type: application/json');

// Cek sesi (bisa disesuaikan jika ingin tambah cek role spesifik)
...
$where_admin = ($pembina_level === 'kelompok') ? " AND p.kelompok = '$pembina_kelompok' " : "";
