...
final class InsertDetailMateriBacaanAlquran extends AbstractMigration
{
    public function change(): void
    {
        ...
        $row = $this->fetchRow("SELECT id FROM master_materi WHERE nama_kategori = 'Manqul Bacaan Al-Qur''an' LIMIT 1");

        if (empty($row)) {
            // Jika belum ada, batalkan proses insert ini agar tidak error
            echo "Peringatan: Kategori 'Manqul Bacaan Al-Qur'an' tidak ditemukan di master_materi. Insert dibatalkan.\n";
            return;
        }
